...
public class CatppuccinPallette {
    ...
    private static readonly Dictionary<CatppuccinColor, Color> Latte = new() {
        [CatppuccinColor.Crust] = ColorTranslator.FromHtml("#dce0e8"),
        [CatppuccinColor.Mantle] = ColorTranslator.FromHtml("#e6e9ef"),
        [CatppuccinColor.Base] = ColorTranslator.FromHtml("#eff1f5"),
        [CatppuccinColor.Surface0] = ColorTranslator.FromHtml("#ccd0da"),
        [CatppuccinColor.Surface1] = ColorTranslator.FromHtml("#bcc0cc"),
        [CatppuccinColor.Surface2] = ColorTranslator.FromHtml("#acb0be"),
        [CatppuccinColor.Overlay0] = ColorTranslator.FromHtml("#9ca0b0"),
        [CatppuccinColor.Overlay1] = ColorTranslator.FromHtml("#8c8fa1"),
        [CatppuccinColor.Overlay2] = ColorTranslator.FromHtml("#7c7f93"),
        [CatppuccinColor.Subtext0] = ColorTranslator.FromHtml("#6c6f85"),
        [CatppuccinColor.Subtext1] = ColorTranslator.FromHtml("#5c5f77"),
        [CatppuccinColor.Text] = ColorTranslator.FromHtml("#4c4f69"),
        [CatppuccinColor.Lavender] = ColorTranslator.FromHtml("#7287fd"),
        [CatppuccinColor.Blue] = ColorTranslator.FromHtml("#1e66f5"),
        [CatppuccinColor.Sapphire] = ColorTranslator.FromHtml("#209fb5"),
        [CatppuccinColor.Sky] = ColorTranslator.FromHtml("#04a5e5"),
        ...
        [CatppuccinColor.Peach] = ColorTranslator.FromHtml("#fe640b"),
